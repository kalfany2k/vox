const UpcomingEvents = () => {
  return (
    <div className="w-[95%] md:w-[80%] h-[80%] flex flex-col drop-shadow-md hover:drop-shadow-xl event-card hover:bg-purple-800/50 transition-colors duration-300 ease-in-out overflow-hidden">
